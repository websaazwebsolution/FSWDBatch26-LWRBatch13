        ...
        <div class="row mt-5">
            <div class="col-md-6">
                ...
                <form action="register_action.php" method="post">
                    ...
                    <div class="form-group">
                        <label for=""></label>
                        <input type="text" name="cpasswrod" id="" class="form-control" placeholder="" aria-describedby="helpId">
                        <small id="helpId" class="text-muted">Confrom password</small>
                    </div>
