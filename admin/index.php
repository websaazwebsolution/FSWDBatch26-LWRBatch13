            ...
            <div class="col-md-6">
                ...
                <form method="post" action="userdata.php">
                    <div class="form-group">
                        ...
                        <input type="text" name="username" required class="form-control" id="exampleInputName" aria-describedby="nameHelp"
                    ...
                    <div class="form-group">
                        ...
                        <input required type="password" name="confirm_password" class="form-control" id="exampleInputPassword1" placeholder="Password">
                    </div>
